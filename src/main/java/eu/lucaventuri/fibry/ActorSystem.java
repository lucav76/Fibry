...
public class ActorSystem {
    ...
    public static class ActorPoolCreator<S> {
        ...
        private <T, R> PoolActorLeader<T, R, S> createPoolActorLeader(Consumer<S> leaderFinalizer) {
            ...
            return new PoolActorLeader<>(getOrCreateActorQueue(registerActorName(name, false), defaultQueueCapacity), null, groupExit, getQueueFinalizer(name, leaderFinalizer, true));
        }
